...
print("\n Input 1 for linear algebra matrix related functions. [Matrix X and Vector Y]")
print("\n Input 2 for checking invertibility, presence of left and right inverses for a matrix X [alone].",
